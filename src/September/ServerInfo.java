...
/**
 * This class contains Agile PLM server information that all programs in the
 * DocumentationExamples package use to log in.
 */
public class ServerInfo {
      // Update the following fields with information for your server
	final String connectString = "http://192.168.13.250:7001/Agile/";
	final String username = "admin";
	final String password = "agile933";
}
